...
fig = plot_grid(plotlist = list(fig.umap, fig.voom, fig.vp, fig.pct), nrow=2, labels=LETTERS[1:4], align="hv", axis="t")
...
fig = plot_grid(fig.strat1, fig.strat2, align="hv", axis="tb", rel_widths=c(1.5,1), labels=LETTERS[5:6])
fig
...
plot_grid(plotlist = list(fz2, fig.heat1, fig.heat2), 
  nrow=2, ncol=5, labels=LETTERS[7:10], align="hv", axis="t")
```
