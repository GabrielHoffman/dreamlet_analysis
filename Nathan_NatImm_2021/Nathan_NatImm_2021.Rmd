...
fig.zenith = plotZenithResults(res.zenith[idx,], 3, 1, transpose=TRUE)
```
...
fig = plot_grid(plotlist = list(fig.umap, fig.voom, fig.vp, fig.pct, fig.strat2, fig.vol, fz2, fig.heat1, fig.heat2), 
