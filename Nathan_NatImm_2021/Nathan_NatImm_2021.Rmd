...
Show: 1) batch correlates with GC content, 2) Donor correlations with read count per gene
...
plot_grid(list(fig1, fig2, fig3), labels=LETTERS[1:3], nrow=1)
```    
