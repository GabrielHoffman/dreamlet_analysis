...
geneList = getExprGeneNames(pb, min.count=5, min.cells = 10)
...
file = "./topTable_Kfoury_2021_weighted.tsv"
...
plotGeneHeatmap( res.dl, coef="Tumor_Involved", genes=geneIds(go.gs[[gs1]]), transpose=TRUE) + 
  ggtitle(gs1) + 
...
gs1 = "GO0044183: protein folding chaperone"
plotGeneHeatmap( res.dl, coef="Tumor_Involved", genes=geneIds(go.gs[[gs1]]), assay=CT, transpose=TRUE) + 
  ggtitle(gs1) + 
  theme(legend.position = "bottom",
