...
### Involved_Distal
```{r zenith.plot_Involved_Distal, fig.height=18, fig.width=12}
...
```{r combine2, fig.height=5, fig.width=12}
...
lst = list(fig.embed, fig.voom, fig.vp, fig.percent, fig.strat0, fig.strat1, fig.strat2, fig.vol, fig.zenith)
plot_grid(plotlist=lst, nrow=2, ncol=5, labels=LETTERS[1:10], align="hv", axis="t")
```
...
idx3 = idx
res_zenith$assay = factor(res_zenith$assay)
fig.zenith1 = plotZenithResults(res_zenith[idx3,], 5, 3, transpose=TRUE, sortByGeneset=FALSE) + theme(axis.text.x=element_text(size=7), legend.position="right",legend.key.size = unit(.4, 'cm'))
...
idx3 = idx
res_zenith$assay = factor(res_zenith$assay)
fig.zenith2 = plotZenithResults(res_zenith[idx3,], 5, 3, transpose=TRUE, sortByGeneset=FALSE) + theme(axis.text.x=element_text(size=7), legend.position="right",legend.key.size = unit(.4, 'cm'))

plot_grid(fig.zenith1, fig.zenith2)
