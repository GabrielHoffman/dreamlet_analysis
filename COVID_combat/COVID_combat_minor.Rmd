...
```{r zenith.plot.MSigDB, fig.height=80, fig.width=20}
...
figA = plotProjection(sce[,incl], "X_umap", "minor_subset", pointsize=2) + scale_color_manual(values = adjustcolor(paletteer_d("ggsci::default_nejm"), alpha=.6))
