...
hcl = buildClusterTree(sce, "X_pca_regressed_harmony", "anno")

counts = computeCellCounts(sce, "anno", "Channel")
...
plotTreeTest(res) + xlim(0, 12)

res = treeTest( fit, cobj, hcl, coef="AD1", method="RE2C")
plotTreeTest(res) + xlim(0, 12) + ggtitle("RE2C")
```
