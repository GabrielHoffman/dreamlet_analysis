...
genes = c("PTPRG", "TREM2", "NPTP")
plotPercentBars(res.vp[res.vp$gene %in% genes,])
```
...
```{r genehatmap, fig.height=6, fig.width=10}
plotGeneHeatmap( res.dl, coef="AD1", genes=genes)
```

```{r plotForest, fig.height=6, fig.width=10}
plotForest( res.dl, coef = 'AD1', gene = genes[1])
```
