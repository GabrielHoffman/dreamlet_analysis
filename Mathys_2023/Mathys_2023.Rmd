...
cd /sc/arion/projects/CommonMind/hoffman/dreamlet_analysis
R

system("git pull"); rmarkdown::render("Mathys_2023.Rmd");


# https://hoffmg01.u.hpc.mssm.edu/eval_methods2/dreamlet/Kfoury_CancerCell_2021.html
...
```{r load.data}
# read H5AD file
file = "/sc/arion/projects/CommonMind/leed62/ref/published/2023_Mathys_Cell_snRNA/cell_browser/ad-aging-brain/240322_Mathys2023Cell_427snRNA_FINAL.h5ad"
sce = readH5AD(file, use_hdf5=FALSE, verbose=TRUE, obsm=FALSE, uns=FALSE, layers=FALSE, var=FALSE, obs=FALSE)   
